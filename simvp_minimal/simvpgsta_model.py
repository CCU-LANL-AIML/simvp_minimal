...
class SimVP_Model(nn.Module):
    ...
    def __init__(self, in_shape, C_out=None, hid_S=16, hid_T=256, N_S=4, N_T=4,
        ...
        ### self.dec = Decoder(hid_S, C, N_S, spatio_kernel_dec, act_inplace=act_inplace) # Old <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<<
        self.dec = Decoder(hid_S, C_out, N_S, spatio_kernel_dec,
                           act_inplace=act_inplace)  # Modified C_out to C_out <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<<
    ...
    def forward(self, x_raw, **kwargs):
        ...
        Y = self.dec(hid, skip)
        ### Y = Y.reshape(B, T, C, H, W) # Old <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<<
        Y = Y.reshape(B, T, -1, H, W)  # Modified C_out to -1 <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<<
